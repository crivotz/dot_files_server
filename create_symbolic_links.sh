...
ln -sf ~/.dot_files_server/linux/yazi ~/.config/yazi
ln -sf ~/.dot_files_server/linux/asdfrc ~/.asdfrc
ln -sf ~/.dot_files_server/linux/nvm_default_packages ~/.nvm/default-packages
